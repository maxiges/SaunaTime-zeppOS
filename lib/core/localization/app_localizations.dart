...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'backup_export_desc':
          'Save all your sessions in universal JSON format.',
      ...
      'profile_personal_header': 'Personal Details',
      'profile_app_header': 'Application Preferences',
      'profile_sex': 'Sex',
      'profile_male': 'Male',
      ...
      'profile_activity_display': 'Activity chart display',
      'activity_mode_none': 'Hidden',
      'activity_mode_total': 'Total time',
      'activity_mode_side_by_side': 'Side-by-side',
      'activity_mode_stacked': 'Stacked',
      'activity_mode_intensity': 'Sessions (intensity)',
      'activity_mode_rings': 'Rings (goal)',
      'activity_mode_line': 'Line chart',
      'weekly_heating': 'heating',
      ...
      'backup_export_desc_count': 'Save all your sessions ({count} entries) in universal JSON format.',
      // ── About ──
    ...
    'pl': {
      ...
      'notes_hint': 'np. 3 serie, dobra wilgotność, menthol...',
      'change': 'Zmień',
      'cancel': 'Anuluj',
      'delete': 'Usuń',
      ...
      'backup_export_desc': 'Zapisz wszystkie swoje sesje w uniwersalnym formacie JSON.',
      ...
      'profile_personal_header': 'Dane osobowe',
      'profile_app_header': 'Preferencje aplikacji',
      'profile_sex': 'Płeć',
      ...
      'profile_activity_display': 'Widok wykresu aktywności',
      'activity_mode_none': 'Ukryty',
      'activity_mode_total': 'Czas całkowity',
      'activity_mode_side_by_side': 'Obok siebie',
      'activity_mode_stacked': 'Skumulowany',
      'activity_mode_intensity': 'Sesje (intensywność)',
      'activity_mode_rings': 'Pierścienie (cel)',
      'activity_mode_line': 'Wykres liniowy',
      'weekly_heating': 'nagrzewanie',
      ...
      'calorie_formula_note_desc': 'Obliczenia opierają się na formule Keytel, biorąc pod uwagę tętno, wiek, wagę oraz płeć.',
      'calorie_per_min': 'kcal/min',
      ...
      'backup_export_desc_count': 'Zapisz wszystkie swoje sesje ({count} wpisów) w uniwersalnym formacie JSON.',
      // ── About ──
    ...
    'de': {
      ...
      'server_localhost_note': 'Tipp: Wenn Sie die Zepp-App na demselben Gerät verwenden, können Sie in Ihren Uhreinstellungen "localhost" anstelle der IP-Adresse verwenden.',
      ...
      'backup_export_desc':
          'Speichere alle Sitzungen im JSON-Format.',
      ...
      'settings_profile_section': 'Profil',
      'profile_personal_header': 'Persönliche Daten',
      'profile_app_header': 'App-Einstellungen',
      ...
      'profile_activity_display': 'Aktivitätsdiagramm-Ansicht',
      'activity_mode_none': 'Ausgeblendet',
      'activity_mode_total': 'Gesamtzeit',
      'activity_mode_side_by_side': 'Nebeneinander',
      'activity_mode_stacked': 'Gestapelt',
      'activity_mode_intensity': 'Sitzungen (Intensität)',
      'activity_mode_rings': 'Ringe (Ziel)',
      'activity_mode_line': 'Liniendiagramm',
      'weekly_heating': 'aufheizen',
      ...
      'backup_export_desc_count': 'Speichere alle Sitzungen ({count} Einträge) im JSON-Format.',
      // ── About ──
    ...
    'fr': {
      ...
      'server_localhost_note': 'Astuce : Si vous utilisez l\'application Zepp na le même appareil, vous pouvez utiliser "localhost" au lieu de l\'adresse IP dans les paramètres de votre montre.',
      ...
      'backup_export_desc':
          'Enregistrez toutes vos séances au format JSON.',
      ...
      'settings_about_subtitle': "Version et informations na l'application",
      ...
      // ── User profile / calories ──
      'settings_profile_section': 'Profil',
      'profile_personal_header': 'Détails personnels',
      'profile_app_header': 'Préférences de l\'application',
      'profile_sex': 'Sexe',
      'profile_male': 'Homme',
      ...
      'profile_activity_display': 'Affichage du graphique d\'activité',
      'activity_mode_none': 'Masqué',
      'activity_mode_total': 'Temps total',
      'activity_mode_side_by_side': 'Côte à côte',
      'activity_mode_stacked': 'Empilé',
      'activity_mode_intensity': 'Sessions (intensité)',
      'activity_mode_rings': 'Anneaux (objectif)',
      'activity_mode_line': 'Graphique linéaire',
      'weekly_heating': 'échauffement',
      ...
      'home_calories_based_on':
          'basé na {count} séances avec fréquence cardiaque',
      ...
      'calorie_samples_count':
          'basé na {count} échantillons de fréquence cardiaque',
      ...
      'backup_export_desc_count': 'Enregistrez toutes vos séances ({count} entrées) au format JSON.',
      // ── About ──
